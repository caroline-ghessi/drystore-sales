...
-- Create vendor user mapping table for better vendor-user relationship
...
-- Enable RLS on vendor_user_mapping
ALTER TABLE public.vendor_user_mapping ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Admins can manage all vendor mappings"
