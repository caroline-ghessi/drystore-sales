...
INSERT INTO public.products (
  ...
  600.00, 
  450.00,
  '{"coverage_area": 1, "yield_per_unit": 1, "power_per_kit": 1, "installation_factor": 1.0, "weight": 15, "material": "aluminio_anodizado", "fixation_type": "telha_ceramica_metalica"}',
  true,
...
INSERT INTO public.products (
  ...
  300.00,
  200.00,
  '{"service_type": "projeto_documentacao", "power_per_kit": 1, "includes": ["projeto_eletrico", "art", "aprovacao_concessionaria", "homologacao"], "complexity_factor": 1.0, "processing_time_days": 30}',
  true,
...
INSERT INTO public.products (
  ...
  500.00,
  350.00,
  '{"includes": ["dps_cc", "dps_ca", "disjuntores", "fusivel_cc", "cabos_cc", "cabos_ca", "conectores", "terminal_terra"], "power_per_kit": 1, "protection_class": "IP65"}',
  true,
...
INSERT INTO public.products (
  ...
  800.00,
  600.00,
  '{"service_type": "instalacao", "power_per_kit": 1, "complexity_factor": 1.0, "includes": ["montagem_estruturas", "fixacao_modulos", "conexoes_eletricas", "teste_sistema"], "warranty_years": 5, "installation_time_days": 2}',
  true,
