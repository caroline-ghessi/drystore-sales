...
export default function DryStoreDashboard() {
  ...
  return (
    <div className="p-8 space-y-8 bg-drystore-light-gray min-h-full">
      {/* Clean Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-drystore-dark-gray mb-3">Dashboard de Propostas</h1>
        <p className="text-lg text-drystore-medium-gray">{getSubtitle()}</p>
      </div>

      {/* KPIs Section */}
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <h2 className="text-3xl font-bold text-drystore-dark-gray">
      ...
      {isAdmin && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="border-0 shadow-sm bg-white">
            <CardHeader className="pb-6">
              <CardTitle className="text-2xl font-bold text-drystore-dark-gray flex items-center">
                <Award className="mr-3 h-6 w-6 text-drystore-orange" />
                Ranking de Vendedores
              </CardTitle>
              <CardDescription className="text-drystore-medium-gray text-base">Top performers do mês</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-0 shadow-sm bg-white">
            <CardHeader className="pb-6">
              <CardTitle className="text-2xl font-bold text-drystore-dark-gray flex items-center">
                <ShoppingCart className="mr-3 h-6 w-6 text-drystore-orange" />
                Performance por Produto
              </CardTitle>
              <CardDescription className="text-drystore-medium-gray text-base">Produtos mais vendidos</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
      ...
      {isVendor && metrics?.openProposals.recent.length > 0 && (
        <Card className="border-0 shadow-sm bg-white">
          <CardHeader className="pb-6">
            <CardTitle className="text-2xl font-bold text-drystore-dark-gray flex items-center">
              <ClipboardList className="mr-3 h-6 w-6 text-drystore-orange" />
              Propostas Recentes
            </CardTitle>
            <CardDescription className="text-drystore-medium-gray text-base">Suas últimas propostas em andamento</CardDescription>
          </CardHeader>
          <CardContent>
